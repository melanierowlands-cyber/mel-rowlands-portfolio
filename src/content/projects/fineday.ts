      ...
      images: [
        {
          ...
          caption: "Nested Bean - Zen Sack wearable blanket.",
          width: 657,
          height: 802,
        },
        {
          src: "/images/fineday/nested-bean-zen-sack-monogram.jpg",
          alt: "Nested Bean Zen Sack wearable blanket, Monogram Gold print",
          caption: "Nested Bean - Zen Sack, Monogram Gold.",
          width: 690,
          height: 823,
        },
        {
          src: "/images/fineday/mountingbloc-baselayer.jpg",
          alt: "Two girls wearing The Mounting Bloc 'Rainbow Ponies' baselayer riding tops",
